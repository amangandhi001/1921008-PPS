...
## ITA1-1921008
![LOGO](https://https://github.com/gandhiaman001/amanprog/blob/master/logo.jpg
...
45      56      78
```
# 22 programs to addtion of matrics
```C
#include <stdio.h>
int main(){
...
10   8   6  
```
# 23 programs to substract the two matrix
```C
#include<stdio.h>
...
4  6  8
```
# 24 programs to transpose the matrix 
```C
#include <stdio.h>
...
Transpose of matrix is
 ...
 9 5 4
 ```
 # 25 programs to find multiplication of matrix 
 ```C
 #include <stdio.h>
